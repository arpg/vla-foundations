...
The model was trained for **10 epochs** on a dataset of **9,000 samples** using a batch size of **32**, resulting in a total of

\[
\lceil 9000 / 32 \rceil \times 10 = 2820
\]

training iterations. Training converged smoothly over these iterations.
...
The dashed diagonal line highlights the causal boundary; attention is only permitted to earlier positions in the sequence.
