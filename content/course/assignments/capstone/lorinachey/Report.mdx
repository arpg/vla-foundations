---
title: "Lorin Achey (lorinachey): Risk-Aware RL in VLA Training — Capstone Running Log"
github: "lorinachey"
group: "B"
lab: "Action & Policy Benchmark"
resource_ledger: "/capstone/lorinachey/resource-ledger.pdf"
status: "in-progress"
---

# Lorin Achey: Risk-Aware RL in VLA Training — Capstone Running Log
...
[📄 Download Resource Ledger (PDF)](/capstone/lorinachey/resource-ledger.pdf)
...
Reinforcement learning policy risk as part of VLA training.
...
Changes to the action sequence outputs to show different levels of risk tolerance for a simple task.
A risk profile is encoded in the RL policy so the full stack is risk-aware.

### Data Mix Strategy

Open X-Embodiment (OXE) dataset primarily.
A small fine-tuning set collected by the author.

### Compute Requirements

At least 10 hours on a cloud-based training platform (precise estimate pending).
...
Very small scale to start, collected through teleoperation in simulation.
...
**Goal:** Compare a diffusion policy, an autoregressive approach, and an RL approach to visuomotor control with identical datasets and architectures.
