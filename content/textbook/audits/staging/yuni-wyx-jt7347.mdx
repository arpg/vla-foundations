...
1. The probability distribution of the goal masking itself. They chose a Bernoulli distribution with the mean probability of 50/50. There's not a lot of clarity on why this was chosen or studies on other distributions. Is this environment dependent?
