...
While it has a form of handling exploration versus exploitation (by diffusion generation of subgoals and subgoal ranking), it doesn't explicitly have an inherent understanding of the environment it's navigating in.
