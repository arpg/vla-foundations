---
title: "World Models"
author: "Lorin Achey and Carson Kohlbrenner"
paper: "GAIA-1, TesserAct, Genie, Cosmos"
topic: "World Models"
---
...
| Model | Input | Output |
| :--- | :--- | :--- |
| **Genie** | Unlabelled video frames; can be prompted with **text, synthetic images, photographs, or sketches**. | **Action-controllable virtual worlds** (video) generated on a frame-by-frame basis via a learned latent action space. |
